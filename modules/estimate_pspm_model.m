function estimate_pspm_model(datafile, modelfile, Analysis, currentSubjectID)
% Function for specifying a GLM for modeling MICE's scr data
    ...
    matlabbatch = set_model_batch(datafile, modelfile, Analysis.name, fullfile(Analysis.dir, currentSubjectID));
